...
describe('Testing favorite blog', () => {
  ...
  test('Multiple blogs with tie return first one', () => {
    assert.deepStrictEqual(
      listHelper.favoriteBlog(blogs.concat(
        {
...
describe('Testing most blogs', () => {
  ...
  test('Multiple blogs with tie', () => {
    ...
    assert.deepStrictEqual(
      listHelper.mostBlogs(blogs.concat([dummyBlog, dummyBlog, dummyBlog])),
      { author: 'Robert C. Martin', blogs: 3 }
    );
  });
});
...
describe('Testing most likes', () => {
  ...
  test('Multiple blogs with tie', () => {
    ...
    assert.deepStrictEqual(
      listHelper.mostLikes(blogs.concat([dummyBlog1, dummyBlog2])),
      { author: 'Edsger W. Dijkstra', likes: 17 }
    );
  });
});
